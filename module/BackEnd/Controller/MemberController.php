...
class MemberController extends AbstractController
{
	public function indexAction()
	{
        ...
        $order = $this->_getOrder($prefixUrl, array('UserName', 'Points', 'AddTime', 'Email', 'Mobile', 'Nick', 'LastLogin', 'LoginCount', 'LastIP'), $removePageParams);
...
// 		$district = $region->getSelectRegion(4, $dDi);
		...
		$order = $this->_getOrder($prefixUrl, array('UserName', 'Points', 'Email', 'Mobile', 'Nick',
		        'Tel', 'TrueName', 'Gender', 'Address', 'QQ', 'MSN' , 'LastLogin', 'LastIP', 'AddTime', 'LoginCount', 'LastUpdate'), $removePageParams);
	...
	private function _memberSave($form, $requery, $action = 'index')
	{
		...
		$member->LastUpdate = $member->AddTime = Util::getDateTime();
