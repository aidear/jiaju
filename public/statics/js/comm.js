...
var tipper = function() {
    ...
    top -=80;
    var left = (document.body.clientWidth/2-$('#RobPub1Tipper2').clientWidth/2);
    $('#RobPub1Tipper2').css('background-color','#FFF4E9').css('top',top+'px').css('left',left+'px');
    $('#RobPub1Tipper2').show();
...
//(function(){
//	var colorCustom = this.colorCustom = function(selector, val) {
//		this.selector = selector;
//		$this.defColor = '#000';
//		this.init();
//	};
//	colorCustom.prototype = {
//		init : function() {
//			var that = this;
////			$("input[type='color'][name='c_title']").spectrum({
...
//				    $("input[name='title']").css({'color':color.toHexString()});
...
(function(){
	...
	Area.prototype = {
		...
		,distinceInit :function() {
			$(this.options.dist).html('<option value="" >===请选择区域===</option>');
		}
	};
})();